...
pub unsafe fn glMapBufferRange(
    ...
    let _func_p: unsafe extern "system" fn(
        ...
        GLsizeiptr,
        GLbitfield,
    ) -> *mut c_void = unsafe { core::mem::transmute(u) };
...
pub unsafe fn load_gl_functions(
    ...
    let command_info = &[
        ("glActiveShaderProgram", &glActiveShaderProgram_p),
        ("glActiveTexture", &glActiveTexture_p),
        ("glAttachShader", &glAttachShader_p),
        ("glBeginConditionalRender", &glBeginConditionalRender_p),
        ("glBeginQuery", &glBeginQuery_p),
        ("glBeginQueryIndexed", &glBeginQueryIndexed_p),
        ("glBeginTransformFeedback", &glBeginTransformFeedback_p),
        ("glBindAttribLocation", &glBindAttribLocation_p),
        ("glBindBuffer", &glBindBuffer_p),
        ("glBindBufferBase", &glBindBufferBase_p),
        ("glBindBufferRange", &glBindBufferRange_p),
        ("glBindBuffersBase", &glBindBuffersBase_p),
        ("glBindBuffersRange", &glBindBuffersRange_p),
        ("glBindFragDataLocation", &glBindFragDataLocation_p),
        (
            "glBindFragDataLocationIndexed",
            &glBindFragDataLocationIndexed_p,
        ),
        ("glBindFramebuffer", &glBindFramebuffer_p),
        ("glBindImageTexture", &glBindImageTexture_p),
        ("glBindImageTextures", &glBindImageTextures_p),
        ("glBindProgramPipeline", &glBindProgramPipeline_p),
        ("glBindRenderbuffer", &glBindRenderbuffer_p),
        ("glBindSampler", &glBindSampler_p),
        ("glBindSamplers", &glBindSamplers_p),
        ("glBindTexture", &glBindTexture_p),
        ("glBindTextureUnit", &glBindTextureUnit_p),
        ("glBindTextures", &glBindTextures_p),
        ("glBindTransformFeedback", &glBindTransformFeedback_p),
        ("glBindVertexArray", &glBindVertexArray_p),
        ("glBindVertexBuffer", &glBindVertexBuffer_p),
        ("glBindVertexBuffers", &glBindVertexBuffers_p),
        ("glBlendColor", &glBlendColor_p),
        ("glBlendEquation", &glBlendEquation_p),
        ("glBlendEquationSeparate", &glBlendEquationSeparate_p),
        ("glBlendEquationSeparatei", &glBlendEquationSeparatei_p),
        ("glBlendEquationi", &glBlendEquationi_p),
        ("glBlendFunc", &glBlendFunc_p),
        ("glBlendFuncSeparate", &glBlendFuncSeparate_p),
        ("glBlendFuncSeparatei", &glBlendFuncSeparatei_p),
        ("glBlendFunci", &glBlendFunci_p),
        ("glBlitFramebuffer", &glBlitFramebuffer_p),
        ("glBlitNamedFramebuffer", &glBlitNamedFramebuffer_p),
        ("glBufferData", &glBufferData_p),
        ("glBufferStorage", &glBufferStorage_p),
        ("glBufferStorageEXT", &glBufferStorageEXT_p),
        ("glBufferSubData", &glBufferSubData_p),
        ("glCheckFramebufferStatus", &glCheckFramebufferStatus_p),
        (
            "glCheckNamedFramebufferStatus",
            &glCheckNamedFramebufferStatus_p,
        ),
        ("glClampColor", &glClampColor_p),
        ("glClear", &glClear_p),
        ("glClearBufferData", &glClearBufferData_p),
        ("glClearBufferSubData", &glClearBufferSubData_p),
        ("glClearBufferfi", &glClearBufferfi_p),
        ("glClearBufferfv", &glClearBufferfv_p),
        ("glClearBufferiv", &glClearBufferiv_p),
        ("glClearBufferuiv", &glClearBufferuiv_p),
        ("glClearColor", &glClearColor_p),
        ("glClearDepth", &glClearDepth_p),
        ("glClearDepthf", &glClearDepthf_p),
        ("glClearNamedBufferData", &glClearNamedBufferData_p),
        ("glClearNamedBufferSubData", &glClearNamedBufferSubData_p),
        ("glClearNamedFramebufferfi", &glClearNamedFramebufferfi_p),
        ("glClearNamedFramebufferfv", &glClearNamedFramebufferfv_p),
        ("glClearNamedFramebufferiv", &glClearNamedFramebufferiv_p),
        ("glClearNamedFramebufferuiv", &glClearNamedFramebufferuiv_p),
        ("glClearStencil", &glClearStencil_p),
        ("glClearTexImage", &glClearTexImage_p),
        ("glClearTexSubImage", &glClearTexSubImage_p),
        ("glClientWaitSync", &glClientWaitSync_p),
        ("glClipControl", &glClipControl_p),
        ("glColorMask", &glColorMask_p),
        ("glColorMaskIndexedEXT", &glColorMaskIndexedEXT_p),
        ("glColorMaski", &glColorMaski_p),
        ("glCompileShader", &glCompileShader_p),
        ("glCompressedTexImage1D", &glCompressedTexImage1D_p),
        ("glCompressedTexImage2D", &glCompressedTexImage2D_p),
        ("glCompressedTexImage3D", &glCompressedTexImage3D_p),
        ("glCompressedTexSubImage1D", &glCompressedTexSubImage1D_p),
        ("glCompressedTexSubImage2D", &glCompressedTexSubImage2D_p),
        ("glCompressedTexSubImage3D", &glCompressedTexSubImage3D_p),
        (
        ...
        ("glCopyBufferSubData", &glCopyBufferSubData_p),
        ("glCopyBufferSubDataNV", &glCopyBufferSubDataNV_p),
        ("glCopyImageSubData", &glCopyImageSubData_p),
        ("glCopyNamedBufferSubData", &glCopyNamedBufferSubData_p),
        ("glCopyTexImage1D", &glCopyTexImage1D_p),
        ("glCopyTexImage2D", &glCopyTexImage2D_p),
        ("glCopyTexSubImage1D", &glCopyTexSubImage1D_p),
        ("glCopyTexSubImage2D", &glCopyTexSubImage2D_p),
        ("glCopyTexSubImage3D", &glCopyTexSubImage3D_p),
        ("glCopyTextureSubImage1D", &glCopyTextureSubImage1D_p),
        ("glCopyTextureSubImage2D", &glCopyTextureSubImage2D_p),
        ("glCopyTextureSubImage3D", &glCopyTextureSubImage3D_p),
        ("glCreateBuffers", &glCreateBuffers_p),
        ("glCreateFramebuffers", &glCreateFramebuffers_p),
        ("glCreateProgram", &glCreateProgram_p),
        ("glCreateProgramPipelines", &glCreateProgramPipelines_p),
        ("glCreateQueries", &glCreateQueries_p),
        ("glCreateRenderbuffers", &glCreateRenderbuffers_p),
        ("glCreateSamplers", &glCreateSamplers_p),
        ("glCreateShader", &glCreateShader_p),
        ("glCreateShaderProgramv", &glCreateShaderProgramv_p),
        ("glCreateTextures", &glCreateTextures_p),
        ("glCreateTransformFeedbacks", &glCreateTransformFeedbacks_p),
        ("glCreateVertexArrays", &glCreateVertexArrays_p),
        ("glCullFace", &glCullFace_p),
        ("glDebugMessageCallback", &glDebugMessageCallback_p),
        ("glDebugMessageCallbackARB", &glDebugMessageCallbackARB_p),
        ("glDebugMessageControl", &glDebugMessageControl_p),
        ("glDebugMessageControlARB", &glDebugMessageControlARB_p),
        ("glDebugMessageInsert", &glDebugMessageInsert_p),
        ("glDebugMessageInsertARB", &glDebugMessageInsertARB_p),
        ("glDeleteBuffers", &glDeleteBuffers_p),
        ("glDeleteFramebuffers", &glDeleteFramebuffers_p),
        ("glDeleteProgram", &glDeleteProgram_p),
        ("glDeleteProgramPipelines", &glDeleteProgramPipelines_p),
        ("glDeleteQueries", &glDeleteQueries_p),
        ("glDeleteRenderbuffers", &glDeleteRenderbuffers_p),
        ("glDeleteSamplers", &glDeleteSamplers_p),
        ("glDeleteShader", &glDeleteShader_p),
        ("glDeleteSync", &glDeleteSync_p),
        ("glDeleteTextures", &glDeleteTextures_p),
        ("glDeleteTransformFeedbacks", &glDeleteTransformFeedbacks_p),
        ("glDeleteVertexArrays", &glDeleteVertexArrays_p),
        ("glDepthFunc", &glDepthFunc_p),
        ("glDepthMask", &glDepthMask_p),
        ("glDepthRange", &glDepthRange_p),
        ("glDepthRangeArrayv", &glDepthRangeArrayv_p),
        ("glDepthRangeIndexed", &glDepthRangeIndexed_p),
        ("glDepthRangef", &glDepthRangef_p),
        ("glDetachShader", &glDetachShader_p),
        ("glDisable", &glDisable_p),
        ("glDisableIndexedEXT", &glDisableIndexedEXT_p),
        ("glDisableVertexArrayAttrib", &glDisableVertexArrayAttrib_p),
        ("glDisableVertexAttribArray", &glDisableVertexAttribArray_p),
        ("glDisablei", &glDisablei_p),
        ("glDispatchCompute", &glDispatchCompute_p),
        ("glDispatchComputeIndirect", &glDispatchComputeIndirect_p),
        ("glDrawArrays", &glDrawArrays_p),
        ("glDrawArraysIndirect", &glDrawArraysIndirect_p),
        ("glDrawArraysInstanced", &glDrawArraysInstanced_p),
        ("glDrawArraysInstancedARB", &glDrawArraysInstancedARB_p),
        (
            "glDrawArraysInstancedBaseInstance",
            &glDrawArraysInstancedBaseInstance_p,
        ),
        ("glDrawBuffer", &glDrawBuffer_p),
        ("glDrawBuffers", &glDrawBuffers_p),
        ("glDrawElements", &glDrawElements_p),
        ("glDrawElementsBaseVertex", &glDrawElementsBaseVertex_p),
        ("glDrawElementsIndirect", &glDrawElementsIndirect_p),
        ("glDrawElementsInstanced", &glDrawElementsInstanced_p),
        ("glDrawElementsInstancedARB", &glDrawElementsInstancedARB_p),
        (
        ...
        ("glDrawRangeElements", &glDrawRangeElements_p),
        (
            "glDrawRangeElementsBaseVertex",
            &glDrawRangeElementsBaseVertex_p,
        ),
        ("glDrawTransformFeedback", &glDrawTransformFeedback_p),
        (
        ...
        ("glEnable", &glEnable_p),
        ("glEnableIndexedEXT", &glEnableIndexedEXT_p),
        ("glEnableVertexArrayAttrib", &glEnableVertexArrayAttrib_p),
        ("glEnableVertexAttribArray", &glEnableVertexAttribArray_p),
        ("glEnablei", &glEnablei_p),
        ("glEndConditionalRender", &glEndConditionalRender_p),
        ("glEndQuery", &glEndQuery_p),
        ("glEndQueryIndexed", &glEndQueryIndexed_p),
        ("glEndTransformFeedback", &glEndTransformFeedback_p),
        ("glFenceSync", &glFenceSync_p),
        ("glFinish", &glFinish_p),
        ("glFlush", &glFlush_p),
        ("glFlushMappedBufferRange", &glFlushMappedBufferRange_p),
        (
            "glFlushMappedNamedBufferRange",
            &glFlushMappedNamedBufferRange_p,
        ),
        ("glFramebufferParameteri", &glFramebufferParameteri_p),
        ("glFramebufferRenderbuffer", &glFramebufferRenderbuffer_p),
        ("glFramebufferTexture", &glFramebufferTexture_p),
        ("glFramebufferTexture1D", &glFramebufferTexture1D_p),
        ("glFramebufferTexture2D", &glFramebufferTexture2D_p),
        ("glFramebufferTexture3D", &glFramebufferTexture3D_p),
        ("glFramebufferTextureLayer", &glFramebufferTextureLayer_p),
        ("glFrontFace", &glFrontFace_p),
        ("glGenBuffers", &glGenBuffers_p),
        ("glGenFramebuffers", &glGenFramebuffers_p),
        ("glGenProgramPipelines", &glGenProgramPipelines_p),
        ("glGenQueries", &glGenQueries_p),
        ("glGenRenderbuffers", &glGenRenderbuffers_p),
        ("glGenSamplers", &glGenSamplers_p),
        ("glGenTextures", &glGenTextures_p),
        ("glGenTransformFeedbacks", &glGenTransformFeedbacks_p),
        ("glGenVertexArrays", &glGenVertexArrays_p),
        ("glGenerateMipmap", &glGenerateMipmap_p),
        ("glGenerateTextureMipmap", &glGenerateTextureMipmap_p),
        (
            "glGetActiveAtomicCounterBufferiv",
            &glGetActiveAtomicCounterBufferiv_p,
        ),
        ("glGetActiveAttrib", &glGetActiveAttrib_p),
        ("glGetActiveSubroutineName", &glGetActiveSubroutineName_p),
        (
        ...
        ("glGetActiveUniform", &glGetActiveUniform_p),
        (
            "glGetActiveUniformBlockName",
            &glGetActiveUniformBlockName_p,
        ),
        ("glGetActiveUniformBlockiv", &glGetActiveUniformBlockiv_p),
        ("glGetActiveUniformName", &glGetActiveUniformName_p),
        ("glGetActiveUniformsiv", &glGetActiveUniformsiv_p),
        ("glGetAttachedShaders", &glGetAttachedShaders_p),
        ("glGetAttribLocation", &glGetAttribLocation_p),
        ("glGetBooleanIndexedvEXT", &glGetBooleanIndexedvEXT_p),
        ("glGetBooleani_v", &glGetBooleani_v_p),
        ("glGetBooleanv", &glGetBooleanv_p),
        ("glGetBufferParameteri64v", &glGetBufferParameteri64v_p),
        ("glGetBufferParameteriv", &glGetBufferParameteriv_p),
        ("glGetBufferPointerv", &glGetBufferPointerv_p),
        ("glGetBufferSubData", &glGetBufferSubData_p),
        ("glGetCompressedTexImage", &glGetCompressedTexImage_p),
        (
        ...
        ("glGetDebugMessageLog", &glGetDebugMessageLog_p),
        ("glGetDebugMessageLogARB", &glGetDebugMessageLogARB_p),
        ("glGetDoublei_v", &glGetDoublei_v_p),
        ("glGetDoublev", &glGetDoublev_p),
        ("glGetError", &glGetError_p),
        ("glGetFloati_v", &glGetFloati_v_p),
        ("glGetFloatv", &glGetFloatv_p),
        ("glGetFragDataIndex", &glGetFragDataIndex_p),
        ("glGetFragDataLocation", &glGetFragDataLocation_p),
        (
        ...
        ("glGetGraphicsResetStatus", &glGetGraphicsResetStatus_p),
        ("glGetImageHandleARB", &glGetImageHandleARB_p),
        ("glGetInteger64i_v", &glGetInteger64i_v_p),
        ("glGetInteger64v", &glGetInteger64v_p),
        ("glGetIntegerIndexedvEXT", &glGetIntegerIndexedvEXT_p),
        ("glGetIntegeri_v", &glGetIntegeri_v_p),
        ("glGetIntegerv", &glGetIntegerv_p),
        ("glGetInternalformati64v", &glGetInternalformati64v_p),
        ("glGetInternalformativ", &glGetInternalformativ_p),
        ("glGetMultisamplefv", &glGetMultisamplefv_p),
        (
        ...
        ("glGetNamedBufferPointerv", &glGetNamedBufferPointerv_p),
        ("glGetNamedBufferSubData", &glGetNamedBufferSubData_p),
        (
        ...
        ("glGetObjectLabel", &glGetObjectLabel_p),
        ("glGetObjectPtrLabel", &glGetObjectPtrLabel_p),
        ("glGetPointerv", &glGetPointerv_p),
        ("glGetProgramBinary", &glGetProgramBinary_p),
        ("glGetProgramInfoLog", &glGetProgramInfoLog_p),
        ("glGetProgramInterfaceiv", &glGetProgramInterfaceiv_p),
        (
            "glGetProgramPipelineInfoLog",
            &glGetProgramPipelineInfoLog_p,
        ),
        ("glGetProgramPipelineiv", &glGetProgramPipelineiv_p),
        ("glGetProgramResourceIndex", &glGetProgramResourceIndex_p),
        (
        ...
        ("glGetProgramResourceName", &glGetProgramResourceName_p),
        ("glGetProgramResourceiv", &glGetProgramResourceiv_p),
        ("glGetProgramStageiv", &glGetProgramStageiv_p),
        ("glGetProgramiv", &glGetProgramiv_p),
        ("glGetQueryBufferObjecti64v", &glGetQueryBufferObjecti64v_p),
        ("glGetQueryBufferObjectiv", &glGetQueryBufferObjectiv_p),
        (
            "glGetQueryBufferObjectui64v",
            &glGetQueryBufferObjectui64v_p,
        ),
        ("glGetQueryBufferObjectuiv", &glGetQueryBufferObjectuiv_p),
        ("glGetQueryIndexediv", &glGetQueryIndexediv_p),
        ("glGetQueryObjecti64v", &glGetQueryObjecti64v_p),
        ("glGetQueryObjectiv", &glGetQueryObjectiv_p),
        ("glGetQueryObjectui64v", &glGetQueryObjectui64v_p),
        ("glGetQueryObjectuiv", &glGetQueryObjectuiv_p),
        ("glGetQueryiv", &glGetQueryiv_p),
        (
            "glGetRenderbufferParameteriv",
            &glGetRenderbufferParameteriv_p,
        ),
        ("glGetSamplerParameterIiv", &glGetSamplerParameterIiv_p),
        ("glGetSamplerParameterIuiv", &glGetSamplerParameterIuiv_p),
        ("glGetSamplerParameterfv", &glGetSamplerParameterfv_p),
        ("glGetSamplerParameteriv", &glGetSamplerParameteriv_p),
        ("glGetShaderInfoLog", &glGetShaderInfoLog_p),
        ("glGetShaderPrecisionFormat", &glGetShaderPrecisionFormat_p),
        ("glGetShaderSource", &glGetShaderSource_p),
        ("glGetShaderiv", &glGetShaderiv_p),
        ("glGetString", &glGetString_p),
        ("glGetStringi", &glGetStringi_p),
        ("glGetSubroutineIndex", &glGetSubroutineIndex_p),
        (
            "glGetSubroutineUniformLocation",
            &glGetSubroutineUniformLocation_p,
        ),
        ("glGetSynciv", &glGetSynciv_p),
        ("glGetTexImage", &glGetTexImage_p),
        ("glGetTexLevelParameterfv", &glGetTexLevelParameterfv_p),
        ("glGetTexLevelParameteriv", &glGetTexLevelParameteriv_p),
        ("glGetTexParameterIiv", &glGetTexParameterIiv_p),
        ("glGetTexParameterIuiv", &glGetTexParameterIuiv_p),
        ("glGetTexParameterfv", &glGetTexParameterfv_p),
        ("glGetTexParameteriv", &glGetTexParameteriv_p),
        ("glGetTextureHandleARB", &glGetTextureHandleARB_p),
        ("glGetTextureImage", &glGetTextureImage_p),
        (
        ...
        ("glGetTextureParameterIiv", &glGetTextureParameterIiv_p),
        ("glGetTextureParameterIuiv", &glGetTextureParameterIuiv_p),
        ("glGetTextureParameterfv", &glGetTextureParameterfv_p),
        ("glGetTextureParameteriv", &glGetTextureParameteriv_p),
        (
            "glGetTextureSamplerHandleARB",
            &glGetTextureSamplerHandleARB_p,
        ),
        ("glGetTextureSubImage", &glGetTextureSubImage_p),
        (
        ...
        ("glGetTransformFeedbacki_v", &glGetTransformFeedbacki_v_p),
        ("glGetTransformFeedbackiv", &glGetTransformFeedbackiv_p),
        ("glGetUniformBlockIndex", &glGetUniformBlockIndex_p),
        ("glGetUniformIndices", &glGetUniformIndices_p),
        ("glGetUniformLocation", &glGetUniformLocation_p),
        ("glGetUniformSubroutineuiv", &glGetUniformSubroutineuiv_p),
        ("glGetUniformdv", &glGetUniformdv_p),
        ("glGetUniformfv", &glGetUniformfv_p),
        ("glGetUniformiv", &glGetUniformiv_p),
        ("glGetUniformuiv", &glGetUniformuiv_p),
        (
            "glGetVertexArrayIndexed64iv",
            &glGetVertexArrayIndexed64iv_p,
        ),
        ("glGetVertexArrayIndexediv", &glGetVertexArrayIndexediv_p),
        ("glGetVertexArrayiv", &glGetVertexArrayiv_p),
        ("glGetVertexAttribIiv", &glGetVertexAttribIiv_p),
        ("glGetVertexAttribIuiv", &glGetVertexAttribIuiv_p),
        ("glGetVertexAttribLdv", &glGetVertexAttribLdv_p),
        ("glGetVertexAttribLui64vARB", &glGetVertexAttribLui64vARB_p),
        ("glGetVertexAttribPointerv", &glGetVertexAttribPointerv_p),
        ("glGetVertexAttribdv", &glGetVertexAttribdv_p),
        ("glGetVertexAttribfv", &glGetVertexAttribfv_p),
        ("glGetVertexAttribiv", &glGetVertexAttribiv_p),
        ("glGetnCompressedTexImage", &glGetnCompressedTexImage_p),
        ("glGetnTexImage", &glGetnTexImage_p),
        ("glGetnUniformdv", &glGetnUniformdv_p),
        ("glGetnUniformfv", &glGetnUniformfv_p),
        ("glGetnUniformiv", &glGetnUniformiv_p),
        ("glGetnUniformuiv", &glGetnUniformuiv_p),
        ("glHint", &glHint_p),
        ("glInvalidateBufferData", &glInvalidateBufferData_p),
        ("glInvalidateBufferSubData", &glInvalidateBufferSubData_p),
        ("glInvalidateFramebuffer", &glInvalidateFramebuffer_p),
        (
        ...
        ("glInvalidateSubFramebuffer", &glInvalidateSubFramebuffer_p),
        ("glInvalidateTexImage", &glInvalidateTexImage_p),
        ("glInvalidateTexSubImage", &glInvalidateTexSubImage_p),
        ("glIsBuffer", &glIsBuffer_p),
        ("glIsEnabled", &glIsEnabled_p),
        ("glIsEnabledIndexedEXT", &glIsEnabledIndexedEXT_p),
        ("glIsEnabledi", &glIsEnabledi_p),
        ("glIsFramebuffer", &glIsFramebuffer_p),
        ("glIsImageHandleResidentARB", &glIsImageHandleResidentARB_p),
        ("glIsProgram", &glIsProgram_p),
        ("glIsProgramPipeline", &glIsProgramPipeline_p),
        ("glIsQuery", &glIsQuery_p),
        ("glIsRenderbuffer", &glIsRenderbuffer_p),
        ("glIsSampler", &glIsSampler_p),
        ("glIsShader", &glIsShader_p),
        ("glIsSync", &glIsSync_p),
        ("glIsTexture", &glIsTexture_p),
        (
            "glIsTextureHandleResidentARB",
            &glIsTextureHandleResidentARB_p,
        ),
        ("glIsTransformFeedback", &glIsTransformFeedback_p),
        ("glIsVertexArray", &glIsVertexArray_p),
        ("glLineWidth", &glLineWidth_p),
        ("glLinkProgram", &glLinkProgram_p),
        ("glLogicOp", &glLogicOp_p),
        (
        ...
        ("glMapBuffer", &glMapBuffer_p),
        ("glMapBufferRange", &glMapBufferRange_p),
        ("glMapNamedBuffer", &glMapNamedBuffer_p),
        ("glMapNamedBufferRange", &glMapNamedBufferRange_p),
        ("glMemoryBarrier", &glMemoryBarrier_p),
        ("glMemoryBarrierByRegion", &glMemoryBarrierByRegion_p),
        ("glMinSampleShading", &glMinSampleShading_p),
        ("glMultiDrawArrays", &glMultiDrawArrays_p),
        ("glMultiDrawArraysIndirect", &glMultiDrawArraysIndirect_p),
        (
            "glMultiDrawArraysIndirectCount",
            &glMultiDrawArraysIndirectCount_p,
        ),
        ("glMultiDrawElements", &glMultiDrawElements_p),
        (
        ...
        ("glNamedBufferData", &glNamedBufferData_p),
        ("glNamedBufferStorage", &glNamedBufferStorage_p),
        ("glNamedBufferSubData", &glNamedBufferSubData_p),
        (
        ...
        ("glNamedFramebufferTexture", &glNamedFramebufferTexture_p),
        (
            "glNamedFramebufferTextureLayer",
            &glNamedFramebufferTextureLayer_p,
        ),
        ("glNamedRenderbufferStorage", &glNamedRenderbufferStorage_p),
        (
            "glNamedRenderbufferStorageMultisample",
            &glNamedRenderbufferStorageMultisample_p,
        ),
        ("glObjectLabel", &glObjectLabel_p),
        ("glObjectPtrLabel", &glObjectPtrLabel_p),
        ("glPatchParameterfv", &glPatchParameterfv_p),
        ("glPatchParameteri", &glPatchParameteri_p),
        ("glPauseTransformFeedback", &glPauseTransformFeedback_p),
        ("glPixelStoref", &glPixelStoref_p),
        ("glPixelStorei", &glPixelStorei_p),
        ("glPointParameterf", &glPointParameterf_p),
        ("glPointParameterfv", &glPointParameterfv_p),
        ("glPointParameteri", &glPointParameteri_p),
        ("glPointParameteriv", &glPointParameteriv_p),
        ("glPointSize", &glPointSize_p),
        ("glPolygonMode", &glPolygonMode_p),
        ("glPolygonOffset", &glPolygonOffset_p),
        ("glPolygonOffsetClamp", &glPolygonOffsetClamp_p),
        ("glPopDebugGroup", &glPopDebugGroup_p),
        ("glPrimitiveRestartIndex", &glPrimitiveRestartIndex_p),
        ("glProgramBinary", &glProgramBinary_p),
        ("glProgramParameteri", &glProgramParameteri_p),
        ("glProgramUniform1d", &glProgramUniform1d_p),
        ("glProgramUniform1dv", &glProgramUniform1dv_p),
        ("glProgramUniform1f", &glProgramUniform1f_p),
        ("glProgramUniform1fv", &glProgramUniform1fv_p),
        ("glProgramUniform1i", &glProgramUniform1i_p),
        ("glProgramUniform1iv", &glProgramUniform1iv_p),
        ("glProgramUniform1ui", &glProgramUniform1ui_p),
        ("glProgramUniform1uiv", &glProgramUniform1uiv_p),
        ("glProgramUniform2d", &glProgramUniform2d_p),
        ("glProgramUniform2dv", &glProgramUniform2dv_p),
        ("glProgramUniform2f", &glProgramUniform2f_p),
        ("glProgramUniform2fv", &glProgramUniform2fv_p),
        ("glProgramUniform2i", &glProgramUniform2i_p),
        ("glProgramUniform2iv", &glProgramUniform2iv_p),
        ("glProgramUniform2ui", &glProgramUniform2ui_p),
        ("glProgramUniform2uiv", &glProgramUniform2uiv_p),
        ("glProgramUniform3d", &glProgramUniform3d_p),
        ("glProgramUniform3dv", &glProgramUniform3dv_p),
        ("glProgramUniform3f", &glProgramUniform3f_p),
        ("glProgramUniform3fv", &glProgramUniform3fv_p),
        ("glProgramUniform3i", &glProgramUniform3i_p),
        ("glProgramUniform3iv", &glProgramUniform3iv_p),
        ("glProgramUniform3ui", &glProgramUniform3ui_p),
        ("glProgramUniform3uiv", &glProgramUniform3uiv_p),
        ("glProgramUniform4d", &glProgramUniform4d_p),
        ("glProgramUniform4dv", &glProgramUniform4dv_p),
        ("glProgramUniform4f", &glProgramUniform4f_p),
        ("glProgramUniform4fv", &glProgramUniform4fv_p),
        ("glProgramUniform4i", &glProgramUniform4i_p),
        ("glProgramUniform4iv", &glProgramUniform4iv_p),
        ("glProgramUniform4ui", &glProgramUniform4ui_p),
        ("glProgramUniform4uiv", &glProgramUniform4uiv_p),
        (
        ...
        ("glProgramUniformMatrix2dv", &glProgramUniformMatrix2dv_p),
        ("glProgramUniformMatrix2fv", &glProgramUniformMatrix2fv_p),
        (
        ...
        ("glProgramUniformMatrix3dv", &glProgramUniformMatrix3dv_p),
        ("glProgramUniformMatrix3fv", &glProgramUniformMatrix3fv_p),
        (
        ...
        ("glProgramUniformMatrix4dv", &glProgramUniformMatrix4dv_p),
        ("glProgramUniformMatrix4fv", &glProgramUniformMatrix4fv_p),
        (
        ...
        ("glProvokingVertex", &glProvokingVertex_p),
        ("glPushDebugGroup", &glPushDebugGroup_p),
        ("glQueryCounter", &glQueryCounter_p),
        ("glReadBuffer", &glReadBuffer_p),
        ("glReadPixels", &glReadPixels_p),
        ("glReadnPixels", &glReadnPixels_p),
        ("glReleaseShaderCompiler", &glReleaseShaderCompiler_p),
        ("glRenderbufferStorage", &glRenderbufferStorage_p),
        (
            "glRenderbufferStorageMultisample",
            &glRenderbufferStorageMultisample_p,
        ),
        ("glResumeTransformFeedback", &glResumeTransformFeedback_p),
        ("glSampleCoverage", &glSampleCoverage_p),
        ("glSampleMaski", &glSampleMaski_p),
        ("glSamplerParameterIiv", &glSamplerParameterIiv_p),
        ("glSamplerParameterIuiv", &glSamplerParameterIuiv_p),
        ("glSamplerParameterf", &glSamplerParameterf_p),
        ("glSamplerParameterfv", &glSamplerParameterfv_p),
        ("glSamplerParameteri", &glSamplerParameteri_p),
        ("glSamplerParameteriv", &glSamplerParameteriv_p),
        ("glScissor", &glScissor_p),
        ("glScissorArrayv", &glScissorArrayv_p),
        ("glScissorIndexed", &glScissorIndexed_p),
        ("glScissorIndexedv", &glScissorIndexedv_p),
        ("glShaderBinary", &glShaderBinary_p),
        ("glShaderSource", &glShaderSource_p),
        (
            "glShaderStorageBlockBinding",
            &glShaderStorageBlockBinding_p,
        ),
        ("glSpecializeShader", &glSpecializeShader_p),
        ("glStencilFunc", &glStencilFunc_p),
        ("glStencilFuncSeparate", &glStencilFuncSeparate_p),
        ("glStencilMask", &glStencilMask_p),
        ("glStencilMaskSeparate", &glStencilMaskSeparate_p),
        ("glStencilOp", &glStencilOp_p),
        ("glStencilOpSeparate", &glStencilOpSeparate_p),
        ("glTexBuffer", &glTexBuffer_p),
        ("glTexBufferRange", &glTexBufferRange_p),
        ("glTexImage1D", &glTexImage1D_p),
        ("glTexImage2D", &glTexImage2D_p),
        ("glTexImage2DMultisample", &glTexImage2DMultisample_p),
        ("glTexImage3D", &glTexImage3D_p),
        ("glTexImage3DMultisample", &glTexImage3DMultisample_p),
        ("glTexParameterIiv", &glTexParameterIiv_p),
        ("glTexParameterIuiv", &glTexParameterIuiv_p),
        ("glTexParameterf", &glTexParameterf_p),
        ("glTexParameterfv", &glTexParameterfv_p),
        ("glTexParameteri", &glTexParameteri_p),
        ("glTexParameteriv", &glTexParameteriv_p),
        ("glTexStorage1D", &glTexStorage1D_p),
        ("glTexStorage2D", &glTexStorage2D_p),
        ("glTexStorage2DMultisample", &glTexStorage2DMultisample_p),
        ("glTexStorage3D", &glTexStorage3D_p),
        ("glTexStorage3DMultisample", &glTexStorage3DMultisample_p),
        ("glTexSubImage1D", &glTexSubImage1D_p),
        ("glTexSubImage2D", &glTexSubImage2D_p),
        ("glTexSubImage3D", &glTexSubImage3D_p),
        ("glTextureBarrier", &glTextureBarrier_p),
        ("glTextureBuffer", &glTextureBuffer_p),
        ("glTextureBufferRange", &glTextureBufferRange_p),
        ("glTextureParameterIiv", &glTextureParameterIiv_p),
        ("glTextureParameterIuiv", &glTextureParameterIuiv_p),
        ("glTextureParameterf", &glTextureParameterf_p),
        ("glTextureParameterfv", &glTextureParameterfv_p),
        ("glTextureParameteri", &glTextureParameteri_p),
        ("glTextureParameteriv", &glTextureParameteriv_p),
        ("glTextureStorage1D", &glTextureStorage1D_p),
        ("glTextureStorage2D", &glTextureStorage2D_p),
        (
            "glTextureStorage2DMultisample",
            &glTextureStorage2DMultisample_p,
        ),
        ("glTextureStorage3D", &glTextureStorage3D_p),
        (
            "glTextureStorage3DMultisample",
            &glTextureStorage3DMultisample_p,
        ),
        ("glTextureSubImage1D", &glTextureSubImage1D_p),
        ("glTextureSubImage2D", &glTextureSubImage2D_p),
        ("glTextureSubImage3D", &glTextureSubImage3D_p),
        ("glTextureView", &glTextureView_p),
        (
        ...
        ("glUniform1d", &glUniform1d_p),
        ("glUniform1dv", &glUniform1dv_p),
        ("glUniform1f", &glUniform1f_p),
        ("glUniform1fv", &glUniform1fv_p),
        ("glUniform1i", &glUniform1i_p),
        ("glUniform1iv", &glUniform1iv_p),
        ("glUniform1ui", &glUniform1ui_p),
        ("glUniform1uiv", &glUniform1uiv_p),
        ("glUniform2d", &glUniform2d_p),
        ("glUniform2dv", &glUniform2dv_p),
        ("glUniform2f", &glUniform2f_p),
        ("glUniform2fv", &glUniform2fv_p),
        ("glUniform2i", &glUniform2i_p),
        ("glUniform2iv", &glUniform2iv_p),
        ("glUniform2ui", &glUniform2ui_p),
        ("glUniform2uiv", &glUniform2uiv_p),
        ("glUniform3d", &glUniform3d_p),
        ("glUniform3dv", &glUniform3dv_p),
        ("glUniform3f", &glUniform3f_p),
        ("glUniform3fv", &glUniform3fv_p),
        ("glUniform3i", &glUniform3i_p),
        ("glUniform3iv", &glUniform3iv_p),
        ("glUniform3ui", &glUniform3ui_p),
        ("glUniform3uiv", &glUniform3uiv_p),
        ("glUniform4d", &glUniform4d_p),
        ("glUniform4dv", &glUniform4dv_p),
        ("glUniform4f", &glUniform4f_p),
        ("glUniform4fv", &glUniform4fv_p),
        ("glUniform4i", &glUniform4i_p),
        ("glUniform4iv", &glUniform4iv_p),
        ("glUniform4ui", &glUniform4ui_p),
        ("glUniform4uiv", &glUniform4uiv_p),
        ("glUniformBlockBinding", &glUniformBlockBinding_p),
        ("glUniformHandleui64ARB", &glUniformHandleui64ARB_p),
        ("glUniformHandleui64vARB", &glUniformHandleui64vARB_p),
        ("glUniformMatrix2dv", &glUniformMatrix2dv_p),
        ("glUniformMatrix2fv", &glUniformMatrix2fv_p),
        ("glUniformMatrix2x3dv", &glUniformMatrix2x3dv_p),
        ("glUniformMatrix2x3fv", &glUniformMatrix2x3fv_p),
        ("glUniformMatrix2x4dv", &glUniformMatrix2x4dv_p),
        ("glUniformMatrix2x4fv", &glUniformMatrix2x4fv_p),
        ("glUniformMatrix3dv", &glUniformMatrix3dv_p),
        ("glUniformMatrix3fv", &glUniformMatrix3fv_p),
        ("glUniformMatrix3x2dv", &glUniformMatrix3x2dv_p),
        ("glUniformMatrix3x2fv", &glUniformMatrix3x2fv_p),
        ("glUniformMatrix3x4dv", &glUniformMatrix3x4dv_p),
        ("glUniformMatrix3x4fv", &glUniformMatrix3x4fv_p),
        ("glUniformMatrix4dv", &glUniformMatrix4dv_p),
        ("glUniformMatrix4fv", &glUniformMatrix4fv_p),
        ("glUniformMatrix4x2dv", &glUniformMatrix4x2dv_p),
        ("glUniformMatrix4x2fv", &glUniformMatrix4x2fv_p),
        ("glUniformMatrix4x3dv", &glUniformMatrix4x3dv_p),
        ("glUniformMatrix4x3fv", &glUniformMatrix4x3fv_p),
        ("glUniformSubroutinesuiv", &glUniformSubroutinesuiv_p),
        ("glUnmapBuffer", &glUnmapBuffer_p),
        ("glUnmapNamedBuffer", &glUnmapNamedBuffer_p),
        ("glUseProgram", &glUseProgram_p),
        ("glUseProgramStages", &glUseProgramStages_p),
        ("glValidateProgram", &glValidateProgram_p),
        ("glValidateProgramPipeline", &glValidateProgramPipeline_p),
        ("glVertexArrayAttribBinding", &glVertexArrayAttribBinding_p),
        ("glVertexArrayAttribFormat", &glVertexArrayAttribFormat_p),
        ("glVertexArrayAttribIFormat", &glVertexArrayAttribIFormat_p),
        ("glVertexArrayAttribLFormat", &glVertexArrayAttribLFormat_p),
        (
            "glVertexArrayBindingDivisor",
            &glVertexArrayBindingDivisor_p,
        ),
        ("glVertexArrayElementBuffer", &glVertexArrayElementBuffer_p),
        ("glVertexArrayVertexBuffer", &glVertexArrayVertexBuffer_p),
        ("glVertexArrayVertexBuffers", &glVertexArrayVertexBuffers_p),
        ("glVertexAttrib1d", &glVertexAttrib1d_p),
        ("glVertexAttrib1dv", &glVertexAttrib1dv_p),
        ("glVertexAttrib1f", &glVertexAttrib1f_p),
        ("glVertexAttrib1fv", &glVertexAttrib1fv_p),
        ("glVertexAttrib1s", &glVertexAttrib1s_p),
        ("glVertexAttrib1sv", &glVertexAttrib1sv_p),
        ("glVertexAttrib2d", &glVertexAttrib2d_p),
        ("glVertexAttrib2dv", &glVertexAttrib2dv_p),
        ("glVertexAttrib2f", &glVertexAttrib2f_p),
        ("glVertexAttrib2fv", &glVertexAttrib2fv_p),
        ("glVertexAttrib2s", &glVertexAttrib2s_p),
        ("glVertexAttrib2sv", &glVertexAttrib2sv_p),
        ("glVertexAttrib3d", &glVertexAttrib3d_p),
        ("glVertexAttrib3dv", &glVertexAttrib3dv_p),
        ("glVertexAttrib3f", &glVertexAttrib3f_p),
        ("glVertexAttrib3fv", &glVertexAttrib3fv_p),
        ("glVertexAttrib3s", &glVertexAttrib3s_p),
        ("glVertexAttrib3sv", &glVertexAttrib3sv_p),
        ("glVertexAttrib4Nbv", &glVertexAttrib4Nbv_p),
        ("glVertexAttrib4Niv", &glVertexAttrib4Niv_p),
        ("glVertexAttrib4Nsv", &glVertexAttrib4Nsv_p),
        ("glVertexAttrib4Nub", &glVertexAttrib4Nub_p),
        ("glVertexAttrib4Nubv", &glVertexAttrib4Nubv_p),
        ("glVertexAttrib4Nuiv", &glVertexAttrib4Nuiv_p),
        ("glVertexAttrib4Nusv", &glVertexAttrib4Nusv_p),
        ("glVertexAttrib4bv", &glVertexAttrib4bv_p),
        ("glVertexAttrib4d", &glVertexAttrib4d_p),
        ("glVertexAttrib4dv", &glVertexAttrib4dv_p),
        ("glVertexAttrib4f", &glVertexAttrib4f_p),
        ("glVertexAttrib4fv", &glVertexAttrib4fv_p),
        ("glVertexAttrib4iv", &glVertexAttrib4iv_p),
        ("glVertexAttrib4s", &glVertexAttrib4s_p),
        ("glVertexAttrib4sv", &glVertexAttrib4sv_p),
        ("glVertexAttrib4ubv", &glVertexAttrib4ubv_p),
        ("glVertexAttrib4uiv", &glVertexAttrib4uiv_p),
        ("glVertexAttrib4usv", &glVertexAttrib4usv_p),
        ("glVertexAttribBinding", &glVertexAttribBinding_p),
        ("glVertexAttribDivisor", &glVertexAttribDivisor_p),
        ("glVertexAttribDivisorARB", &glVertexAttribDivisorARB_p),
        ("glVertexAttribFormat", &glVertexAttribFormat_p),
        ("glVertexAttribI1i", &glVertexAttribI1i_p),
        ("glVertexAttribI1iv", &glVertexAttribI1iv_p),
        ("glVertexAttribI1ui", &glVertexAttribI1ui_p),
        ("glVertexAttribI1uiv", &glVertexAttribI1uiv_p),
        ("glVertexAttribI2i", &glVertexAttribI2i_p),
        ("glVertexAttribI2iv", &glVertexAttribI2iv_p),
        ("glVertexAttribI2ui", &glVertexAttribI2ui_p),
        ("glVertexAttribI2uiv", &glVertexAttribI2uiv_p),
        ("glVertexAttribI3i", &glVertexAttribI3i_p),
        ("glVertexAttribI3iv", &glVertexAttribI3iv_p),
        ("glVertexAttribI3ui", &glVertexAttribI3ui_p),
        ("glVertexAttribI3uiv", &glVertexAttribI3uiv_p),
        ("glVertexAttribI4bv", &glVertexAttribI4bv_p),
        ("glVertexAttribI4i", &glVertexAttribI4i_p),
        ("glVertexAttribI4iv", &glVertexAttribI4iv_p),
        ("glVertexAttribI4sv", &glVertexAttribI4sv_p),
        ("glVertexAttribI4ubv", &glVertexAttribI4ubv_p),
        ("glVertexAttribI4ui", &glVertexAttribI4ui_p),
        ("glVertexAttribI4uiv", &glVertexAttribI4uiv_p),
        ("glVertexAttribI4usv", &glVertexAttribI4usv_p),
        ("glVertexAttribIFormat", &glVertexAttribIFormat_p),
        ("glVertexAttribIPointer", &glVertexAttribIPointer_p),
        ("glVertexAttribL1d", &glVertexAttribL1d_p),
        ("glVertexAttribL1dv", &glVertexAttribL1dv_p),
        ("glVertexAttribL1ui64ARB", &glVertexAttribL1ui64ARB_p),
        ("glVertexAttribL1ui64vARB", &glVertexAttribL1ui64vARB_p),
        ("glVertexAttribL2d", &glVertexAttribL2d_p),
        ("glVertexAttribL2dv", &glVertexAttribL2dv_p),
        ("glVertexAttribL3d", &glVertexAttribL3d_p),
        ("glVertexAttribL3dv", &glVertexAttribL3dv_p),
        ("glVertexAttribL4d", &glVertexAttribL4d_p),
        ("glVertexAttribL4dv", &glVertexAttribL4dv_p),
        ("glVertexAttribLFormat", &glVertexAttribLFormat_p),
        ("glVertexAttribLPointer", &glVertexAttribLPointer_p),
        ("glVertexAttribP1ui", &glVertexAttribP1ui_p),
        ("glVertexAttribP1uiv", &glVertexAttribP1uiv_p),
        ("glVertexAttribP2ui", &glVertexAttribP2ui_p),
        ("glVertexAttribP2uiv", &glVertexAttribP2uiv_p),
        ("glVertexAttribP3ui", &glVertexAttribP3ui_p),
        ("glVertexAttribP3uiv", &glVertexAttribP3uiv_p),
        ("glVertexAttribP4ui", &glVertexAttribP4ui_p),
        ("glVertexAttribP4uiv", &glVertexAttribP4uiv_p),
        ("glVertexAttribPointer", &glVertexAttribPointer_p),
        ("glVertexBindingDivisor", &glVertexBindingDivisor_p),
        ("glViewport", &glViewport_p),
        ("glViewportArrayv", &glViewportArrayv_p),
        ("glViewportIndexedf", &glViewportIndexedf_p),
        ("glViewportIndexedfv", &glViewportIndexedfv_p),
        ("glWaitSync", &glWaitSync_p),
    ];
